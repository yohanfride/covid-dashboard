                            ...
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" method="post" action="" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="5"  name="top_content" required=""><?= $data->userg_top_content?></textarea>
                                        </div>
                                    </div>                                                                 

                                    <div class="form-group">
                                        <label class="col-md-12">Left Content</label>
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="8"  name="left_content" required=""><?= $data->userg_left_content?></textarea>
                                        </div>
                                    </div>  
                                    <?php if(!empty($data->userg_image)){ ?>                      
                                    <div class="form-group" style="text-align: center;">
                                        <img class="img-responsive" style="max-height: 300px; max-width: 80%; border: 2px #ddd solid; " src="<?= base_url()?>assets_front/img/<?= $data->userg_image?>" alt="project image"/>
                                    </div>
                                    <?php } ?>
