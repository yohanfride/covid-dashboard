                 ...
                 <div class="row">                    
                    <div class="col-md-6">
                        <div class="card card-body">
                            ...
                            <form class="form-horizontal form-material" method="post" id="TitleForm" onsubmit="return false;" action="<?= base_url()?>question/add_j">
                                <div class="form-group">
                                    <label class="col-md-12">Title of Questionnaire </label>
                                    <div class="col-md-12">
                                        <input type="text" value="" placeholder="" name="title" class="form-control form-control-line" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-b-0">
                                    <div class="offset-sm-3 col-sm-9">
                                        <button type="submit"  id="AddTitle" class="btn btn-info waves-effect waves-light m-t-10">Add Questions</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card card-body">
                            ...
                            <form class="form-horizontal form-material" method="post" id="ItemForm" onsubmit="return false;" action="<?= base_url()?>question/add_j">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="form-control" rows="5" required=""  name="title"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                form-control-line">
                                <input type="hidden" value="" placeholder=" " name="id" id="Parent" class="form-control form-control-line">
                                <input type="hidden" name="save" value="save" placeholder="" class="form-control form-control-line">
                                <div class="form-group m-b-0">
                                    <div class="offset-sm-3 col-sm-9">
