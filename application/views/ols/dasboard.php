	...
	<div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex p-10 no-block">
                        <div class="align-self-center display-6 m-r-20"><i class="text-success icon-Aerobics-3"></i></div>
                        <div class="align-slef-center">
                            <h2 class="m-b-0"><?= $count_athlete?> <small><i class="ti-angle-down text-danger"></i></small></h2>
                            <h6 class="text-muted m-b-0">Total Athlete</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex p-10 no-block">
                        <div class="align-self-center display-6 m-r-20"><i class="text-info icon-Calendar-4"></i></div>
                        <div class="align-slef-center">
                            <h2 class="m-b-0"><?= $count_schedule?> <small><i class="ti-angle-up text-success"></i></small></h2>
                            <h6 class="text-muted m-b-0">Total Schedule</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex p-10 no-block">
                        <div class="align-self-center display-6 m-r-20"><i class="text-primary icon-Notepad"></i></div>
                        <div class="align-slef-center">
                            <h2 class="m-b-0"><?= $count_kuisoner?> <small><i class="ti-angle-up text-success"></i></small></h2>
                            <h6 class="text-muted m-b-0">Questionniare Added</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex p-10 no-block">
                        <div class="align-self-center display-6 m-r-20"><i class="text-danger icon-Notepad"></i></div>
                        <div class="align-slef-center">
                            <h2 class="m-b-0"><?= $count_questions?> <small><i class="ti-angle-down text-danger"></i></small></h2>
                            <h6 class="text-muted m-b-0">Questionniare Questions</h6>
                        </div>
                    </div>
                </div>
            </div>
