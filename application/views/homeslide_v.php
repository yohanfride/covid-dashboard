                ...
                <div class="col-md-12">
                    ...
                    <div class="card no-b">
                        ...
                        <div class="card-title">
                            ...
                            <a href="<?= base_url()?>homeslide/add" style="position: absolute; right:35px; top:15px;z-index: 1;">
                        ...
                        <table class="table table-bordered table-hover data-tables"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                         <img style="max-height: 80px;" src="<?= $url_media.'homeslide/'.$s->gambar; ?>" alt="no-image">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?= base_url()?>homeslide/edit/<?= $s->_id?>"><button type="button" class="btn  btn-xs btn-warning r-20"><i class="icon-pencil"></i> Edit</button></a>
                                        <a href="<?= base_url()?>homeslide/delete/<?= $s->_id?>" class="btn-delete"><button type="button" class="btn btn-xs btn-danger r-20"><i class="icon-trash"></i> Hapus</button></a>
