        ...
        <div class="container-fluid text-white">
            ...
            <div class="row ">
                <ul class="nav responsive-tab">
                    ...
                    <li class="nav-item">
                        <a style="padding: .5rem;" class="nav-link" href="#"><i style="padding-right: 5px;" class="icon icon-hospital-o"></i>Manajemen Tautan Video</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card no-b">
                        ...
                        <div class="card-title">
                            <h4>Data Tautan Video</h4> 
                            <a href="<?= base_url()?>video/add" style="position: absolute; right:35px; top:15px;z-index: 1;">
                        ...
                        <table class="table table-bordered table-hover data-tables"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $s->jenis ?></td>
                                    <td>
                                        <?php if($s->highlight == 0){ ?>
                                        <span class="badge badge-warning r-20">Tidak</span>
                                        <?php } else if($s->highlight == 1){ ?>
                                        <span class="badge badge-primary r-20">Highlight</span>
                                        <?php } ?>
                                    </td><td>
                                        <?php if($s->status == 0){ ?>
                                    ...
                                    <td>
                                        <a href="<?= base_url()?>video/edit/<?= $s->_id?>"><button type="button" class="btn  btn-xs btn-warning r-20"><i class="icon-pencil"></i> Edit</button></a>
                                        <a href="<?= base_url()?>video/delete/<?= $s->_id?>" class="btn-delete"><button type="button" class="btn btn-xs btn-danger r-20"><i class="icon-trash"></i> Hapus</button></a>
